...
import { Search, Filter, X, Tag, Star, Clock, TrendingUp, Loader2, ArrowLeft } from 'lucide-react'
...
import type { Tool, Category, ToolsResponse } from '../../src/services/toolService'
...
function SearchPageContent() {
  ...
  const updateURL = () => {
    ...
    if (priceFilter) {
      params.set('pricing', priceFilter)
    }
    if (platformFilter) {
